                ...
                <form onSubmit={handleSubmit}>
                        ...
                        <div className="col-md-6">
                            <div className="d-flex gap-3">
                                <div className="flex-fill">
                                    ...
                                    <input type="date" name="startDate" value={formData.startDate.split('T')[0]} onChange={handleChange} className="form-control rounded-pill" />
                                </div>
                                <div className="flex-fill">
                                    <label className="form-label text-muted">End Date *</label>
                                    <input type="date" name="endDate" value={formData.endDate.split('T')[0]} onChange={handleChange} className="form-control rounded-pill" />
                                </div>
                            </div>
                            <div>
                            ...
                            <div className="mt-3">
                                ...
                                {previewImage && (
                                    <div className="mt-2 text-center">
                                        <img src={previewImage} alt="Event" className="img-fluid rounded shadow" style={{ maxHeight: "250px", objectFit: "cover" }} />
                                    </div>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="d-flex justify-content-center gap-3 mt-4">
                        <button type="submit" className="btn btn-success rounded-pill px-4">
                            <i className="bi bi-save me-2"></i> Update Event
                        </button>
                        <button type="button" onClick={handleDelete} className="btn btn-outline-danger rounded-pill px-4">
